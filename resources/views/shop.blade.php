                ...
                <div class="slide-split_text position-relative d-flex align-items-center"
                  ...
                  <div class="slideshow-text container p-3 p-xl-5">
                    <h2
                      ...
                      Art<br /><strong>SUPPLIES</strong></h2>
                    <p class="mb-0 animate animate_fade animate_btt animate_delay-5">Fuel your creativity with art supplies that inspire! 
                      From vibrant hues to versatile tools, bring your ideas to life effortlessly.</h6>
                  </div>
                </div>
                <div class="slide-split_media position-relative">
                  <div class="slideshow-bg" style="background-color: #f5e6e0;">
                    <img loading="lazy" src="assets/images/shop/Art_Supplies.jpg" width="630" height="450"
                      alt="Art Supplies" class="slideshow-bg__img object-fit-cover" />
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
                <div class="slide-split_text position-relative d-flex align-items-center"
                  ...
                  <div class="slideshow-text container p-3 p-xl-5">
                    <h2
                      class="text-uppercase section-title fw-normal mb-3 animate animate_fade animate_btt animate_delay-2">
                      Classroom <br /><strong>ACCESSORIES</strong></h2>
                    <p class="mb-0 animate animate_fade animate_btt animate_delay-5">"Classroom accessories bring style and function 
                      to your study space. Stay organized, inspired, and ready to learn with timeless tools and fresh designs."</h6>
                  </div>
                </div>
                <div class="slide-split_media position-relative">
                  <div class="slideshow-bg" style="background-color: #f5e6e0;">
                    <img loading="lazy" src="assets/images/shop/Classroom_Accessories.jpg" width="630" height="450"
                      alt="Classroom accessories" class="slideshow-bg__img object-fit-cover" />
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
                <div class="slide-split_text position-relative d-flex align-items-center"
                  ...
                  <div class="slideshow-text container p-3 p-xl-5">
                    <h2
                      class="text-uppercase section-title fw-normal mb-3 animate animate_fade animate_btt animate_delay-2">
                      Organization <br /><strong>SUPPLIES</strong></h2>
                    <p class="mb-0 animate animate_fade animate_btt animate_delay-5">Organization supplies are the key to a clutter-free 
                      life. Add style and efficiency with fresh designs or stick to timeless classics for every space.</h6>
                  </div>
                </div>
                <div class="slide-split_media position-relative">
                  <div class="slideshow-bg" style="background-color: #f5e6e0;">
                    <img loading="lazy" src="assets/images/shop/Organization_Supplies.jpg" width="630" height="450"
                      alt="Organizatio Supplies" class="slideshow-bg__img object-fit-cover" />
                  </div>
                </div>
              </div>
            </div>
